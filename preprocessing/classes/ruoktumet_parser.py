...
class RuoktumetParser:
    ...
    def parse_dict(self, file):
        ...
        for i, line in enumerate(lines, 1):
            ...
            rendered = self.to_html(line.strip(), pattern)

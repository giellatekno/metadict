export default {
    ...
    "lookup-result":
        'Sátni "{lemma}" gávdnui {count, plural, =0 {# sátnegirjjis} =1 {# sátnegirjjis} other {# iešguđetlágan sátnegirjjis} }.',
    ...
    "howto-search-title": "Movt geavahit metasátnegirjji",
    "howto-search-body":
        'Geavat ohcanbovssa ohcat sániid vuođđohámiid. Ohcanbovssa bálddas lea dropdown-fállu gos sáhttá váljet ohcangiela. Proseantasymbola (%) lea "wildcard" symbolan. Dien sáhttá bidjat sániid ovddabealde, maŋábealde dahje gasku sániid. Ovddamearkka dihte:',
    "howto-search-example-end":
        'addá buot sániid main lea "{example}" loahpas.',
    "howto-search-example-start":
        'addá buot sániid main lea "{example}" álggus.',

...
const LANGNAMES: Record<string, Record<string, string>> = {
    ...
    sjt: { eng: "Ter Sámi", nob: "Tersamisk", sme: "Darjjesámegiella", fin: "Turjansaame" },
    sma: { eng: "Southern Sámi", nob: "Sørsamisk", sme: "Lullisámegiella", fin: "Eteläsaame" },
    sme: { eng: "Northern Sámi", nob: "Nordsamisk", sme: "Davvisámegiella" },
    smj: { eng: "Lule Sámi", nob: "Lulesamisk", sme: "Julevsámegiella" },
    smn: { eng: "Inari Sámi", nob: "Enaresamisk", sme: "Anárašgiella" },
    sms: { nob: "Skoltesamisk", eng: "Skolt Sámi", sme: "Nuortalašgiella" },
    som: { eng: "Somali", nob: "Somalisk", sme: "Somaligiella" },
    spa: { eng: "Spanish", nob: "Spansk", sme: "Espánnjagiella" },

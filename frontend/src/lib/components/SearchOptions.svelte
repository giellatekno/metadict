...
<DialogButton dialogTitle={m.search_options}>
    {#snippet buttonContent()}
        <span class="font-bold">{m.search_options()}</span>
        <EllipsisIcon class="size-5" />
    {/snippet}
    {#snippet dialogContent()}
        <div class="align-start grid grid-cols-1 gap-4 text-lg sm:grid-cols-2 sm:gap-12">
